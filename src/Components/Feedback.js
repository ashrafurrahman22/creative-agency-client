...
const Feedback = () => {
    return (
        <div style={{fontFamily:"poppins", letterSpacing:"2px"}} className="px-20">
            ...
            <div className='grid grid-cols-3 gap-8'>
                ...
                <div className='card card-body bg-base-100 shadow-2xl'>
                    ...
                    <div className='text-center'>
                        <h1 className='text-2xl font-bold'>Nash Patrik</h1>
                        <h3 className='text-xl'>CEO, Manpol</h3>
                    </div>
                    </div>
                ...
                <div className='card card-body bg-base-100 shadow-2xl'>
                    ...
                    <div className='text-center'>
                        <h1 className='text-2xl font-bold'>Bria Malone</h1>
                        <h3 className='text-xl'>CEO, Manpol</h3>
                    </div>
                    </div>
                        <p>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Eos, tenetur molestiae expedita quae commodi praesentium doloribus obcaecati consequuntur dolores cumque.</p>
                ...
                <div className='card card-body bg-base-100 shadow-2xl'>
                    ...
                    <div className='text-center'>
                        <h1 className='text-2xl font-bold'>Miriam Balone</h1>
                        <h3 className='text-xl'>CEO, Manpol</h3>
                    </div>
                    </div>
                        <p>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Eos, tenetur molestiae expedita quae commodi praesentium doloribus obcaecati consequuntur dolores cumque.</p>
